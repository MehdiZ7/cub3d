...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/05 10:53:12 by mzouhir           #+#    #+#             */
/*   Updated: 2026/01/05 11:13:05 by mzouhir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_pixel_burning(int x, int y, t_mlx_data *data)
{
	t_complex	z;
	t_complex	c;
	int			i;
